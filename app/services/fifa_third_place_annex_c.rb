...
# FIFA World Cup 26 Annex C — 495 third-place combination lookup.
# Source: FIFA FWC2026 regulations + github.com/manganite/wm2026
# rubocop:disable Layout/SpaceInsideHashLiteralBraces, Layout/LineLength
module FifaThirdPlaceAnnexC
  WINNERS = [ "A", "B", "D", "E", "G", "I", "K", "L" ].freeze
  # Key: sorted 8 group letters that produce qualifying thirds.
  # Value: { winner_group => third_placed_group }
  LOOKUP = {
...
# rubocop:enable Layout/SpaceInsideHashLiteralBraces, Layout/LineLength
