    ...
    >
      ...
      <div className="d-flex align-items-center" style={{ flex: 1, justifyContent: "flex-end", gap: 8 }}>
        ...
        {match.home_team?.flag_url && (
          <img src={match.home_team.flag_url} alt="" style={{ width: 26, height: 18, objectFit: "cover", borderRadius: 2 }} />
        )}
      </div>
      ...
      <div className="d-flex align-items-center" style={{ flex: 1, gap: 8 }}>
        {match.away_team?.flag_url && (
          <img src={match.away_team.flag_url} alt="" style={{ width: 26, height: 18, objectFit: "cover", borderRadius: 2 }} />
        )}
  ...
  return (
    <div className="widget-next-match mb-4">
      <div className="widget-title d-flex align-items-center" style={{ gap: 10 }}>
        {competition.logo && (
          <img src={competition.logo} alt="" style={{ width: 22, height: 22, objectFit: "contain" }} />
        )}
