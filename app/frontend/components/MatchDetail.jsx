              ...
              <div className="team-1 w-50">
                <div className="team-details w-100 text-center">
                  {match.home_team?.flag_url
                    ? <img src={match.home_team.flag_url} alt="" className="logo-lg" loading="lazy" style={{ margin: "0 auto 8px" }} />
              ...
              <div className="team-2 w-50">
                <div className="team-details w-100 text-center">
                  {match.away_team?.flag_url
                    ? <img src={match.away_team.flag_url} alt="" className="logo-lg" loading="lazy" style={{ margin: "0 auto 8px" }} />
                    : <span style={{ fontSize: "3rem" }}>🏳️</span>
                  }
